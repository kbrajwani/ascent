                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            ...
                            <form method="post" action="feedbackdelete.php">
...
{
    $res1=$obj->getproject($row["fk_job_id"]);
    $row1=$res1->fetch_assoc();
    $jobn=$row1["title"];

  echo'                                  <tr class="gradeX">
                                        <th>
                                        <input type="checkbox" name="chk[]" value="'.$row["feedback_id"].'"> |
                                        <a href="feedbackdelete.php?id='.$row["feedback_id"].'"><span class="glyphicon glyphicon-trash"></span></a> |
                                        
                                        
                                        <th>'.$row["discription"].'</th>
                                        <th>'.$row["fk_email_id"].'</th>
                                        <th>'.$jobn.'</th>
