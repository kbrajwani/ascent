...
<body>
    ...
    <section class="detail-desc">
        <div class="container white-shadow">
            <div class="row">
                <div class="detail-pic"><img src="<?php echo "../image/".$row["image"]." "?>" class="img" alt="" /></div>
                <div
        ...
        <div class="row no-padd">
            <div class="detail pannel-footer">
                ...
                <div class="col-md-7 col-sm-7">
                    <div class="detail-pannel-footer-btn pull-right"><a href="#" data-toggle="modal" data-target="#bid" class="footer-btn grn-btn" title="">delete</a></div>
                </div>
            </div>
        </div>
        </div>
