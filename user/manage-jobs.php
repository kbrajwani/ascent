            ...
            <div class="row extra-mrg">
                <div class="wrap-search-filter">
                    ...
                    <?php
                        ...
                        $obj=new loginclass();?>
                        <div class="col-md-10 col-sm-10"><input type="text" name="search" class="form-control" placeholder="Keyword: Search By Project Name"></div>
...
else
{
    ...
    $seacrh=$_GET["search"];
$res=$obj->getcompjob1($uid,$seacrh);
...
{ 
            $sid=1;
            echo '    <a href="job-detail.php?'.$row["job_id"].'" class="item-click">
                    <article>
                    ...
                    <div class="brows-job-list">
                            ...
                            <span class="brows-job-sallery"><i class="fa fa-money"></i>'.$row["budget"].'</span>
                            </div>
                            </div>
                        </div>
                        </div>
