...
<!-- Mirrored from live.themezhub.com/job-stock-large-preview/job-stock/browse-jobs-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Oct 2017 15:17:28 GMT -->
<?php session_start();?>
<head>
...
$obj=new loginclass();
$f=$obj->userview($email);
$ff=$f->fetch_assoc();
$uid=$ff["uid"];
$i=null;
$res=$obj->getwishlist($email);
while($row=$res->fetch_assoc())
{   $i=1;
    $ress=$obj->getjobbyid($row["fk_job_id"]);
    $row1=$ress->fetch_assoc();
    $comp=$obj->getcompanybyid($row1["fk_uid"]);
    $rcomp=$comp->fetch_assoc();
        echo ' 
          
        <a href="wishjob-detail.php?id='.$row["fk_job_id"].'" class="item-click">
        <article>
        <div class="col-md-4 col-sm-6">
                ...
                <div class="grid-view brows-job-list">
                    ...
                    <div class="brows-job-company-img"><img src="../image/'.$rcomp["image"].'" class="img-responsive" alt="" /></div>
                    <div class="brows-job-position">
                        <h3>'.$row1["title"].'</h3>
                        <p><span>'.$row1["category"].'</span></p>
                    </div>
                    <div class="brows-job-description">
                        <p>'.$row1["extra_details"].'</p>
                    </div>
                    <div class="brows-job-type"><span class="full-time">'.$row1["job_experience"].'</span></div>
                    
                    <ul class="grid-view-caption">
                        <li>
                            <div class="brows-job-location">
                                <p><i class="fa fa-map-marker"></i>'.$rcomp["location"].'</p>
                            </div>
                        </li>
                        <li>
                            <p><span class="brows-job-sallery"><i class="fa fa-money"></i>'.$row1["budget"].'</span></p>
                        </li>
                    </ul>
                </div>
            </div>
