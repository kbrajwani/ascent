...
while($row=$res->fetch_assoc())
{
    ...
    $rcomp=$comp->fetch_assoc();
        echo '   
        <a href="job-detail.php?'.$row["job_id"].'" class="item-click">
        <article>
        <div class="col-md-4 col-sm-6">
                <div class="grid-view brows-job-list">
                    ...
                    <div class="brows-job-description">
                        <p>'.$row["extra_details"].'</p>
                    </div>
                    <div class="brows-job-type"><span class="full-time">'.$row["job_experience"].'</span></div>
                    <ul class="grid-view-caption">
                        ...
                        <li>
                            <p><span class="brows-job-sallery"><i class="fa fa-money"></i>'.$row["budget"].'</span></p>
                        </li>
                    </ul>
                </div>
            </div>
