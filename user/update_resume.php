...
<body>
    ...
    <div class="section detail-desc">
        <div class="container white-shadow">
            <div class="row">
            <form class="add-feild" method="post" action="updateresume1.php" >
    ...
    <section class="full-detail">
            ...
            <div class="row bottom-mrg extra-mrg">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="input-group"><span class="input-group-addon"><i class="fa fa-dribbble"></i></span><input type="text" name="link" class="form-control"
                                placeholder="Profile Link" value="<?php echo $row1["social_pages"];?>" required></div>
                    </div>
        ...
        <div class="row bottom-mrg extra-mrg">
                ...
                <div class="extra-field-box">
                    <div class="multi-box">
                        <div class="dublicat-box">
                            <div class="col-md-12 col-sm-12"><input type="text" value="<?php echo $row1["skills"];?>" name="skill" required class="form-control" placeholder="Skills, e.g. Css, Html..."></div>
                            <div class="col-md-12 col-sm-12">
