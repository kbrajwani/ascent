    ...
    <div class="detail-desc section">
        <div class="container white-shadow">
            ...
            <div class="row bottom-mrg">
                <form class="add-feild" method="post" action="companyupdate.php">
                    <div class="col-md-6 col-sm-6">
                        <div class="input-group"><input value="<?php echo $row["industry_name"] ?>" type="text" required class="form-control" name="name"; placeholder="Company Name"></div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="input-group">

                        <select required class="form-control input-lg" name="cat">
                    ...
                    <div class="col-md-12 col-sm-12"><input type="text" value="<?php echo $row["company_detail"] ?>" required class="form-control" name="detail" placeholder="Company Description"></div>
            ...
            <div class="row bottom-mrg extra-mrg">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="input-group"><span class="input-group-addon"><i class="fa fa-map-marker"></i></span><input type="text" class="form-control"
                                placeholder="Local E.g. It Park New" name="loc" required value="<?php echo  $row["location"] ?>"></div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="input-group"><span class="input-group-addon"><i class="fa fa-birthday-cake"></i></span><input type="text" class="form-control"
                                placeholder="Date Of establish" name="establish" required value="<?php echo $row["established"] ?>"></div>
                    </div>
            ...
            <div class="row bottom-mrg extra-mrg">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="input-group"><span class="input-group-addon"><i class="fa fa-dribbble"></i></span><input type="text" class="form-control"
                                placeholder="Profile Link" name="link" required value="<?php echo $row["link"] ?>"></div>
                    </div>
