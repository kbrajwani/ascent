...
<!-- Mirrored from live.themezhub.com/job-stock-large-preview/job-stock/company-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Oct 2017 15:17:47 GMT -->
    ...
    <section class="detail-desc">
        <div class="container white-shadow">
            <div class="row">
                ...
                <div
                    class="detail-status"><span>10 Min Days Ago</span></div>
        </div>
        <div class="row bottom-mrg">
            <div class="col-md-8 col-sm-8">
                <div class="detail-desc-caption">
                    <h4><?php echo $row["industry_name"];?></h4><span class="designation"><?php echo $row["work"]?> Company</span>
                    <p><?php echo $row["company_detail"];?></p>
                </div>
            </div>
            <div class="col-md-4 col-sm-4">
                <div class="get-touch">
                    <h4>Get in Touch</h4>
                    <ul>
                        <li><i class="fa fa-map-marker"></i><span><?php echo $row["location"];?></span></li>
                        <li><i class="fa fa-envelope"></i><span><?php echo $row["email_id"];?></span></li>
                        <li><i class="fa fa-globe"></i><span><?php echo $row["link"];?></span></li>
            ...
            <div class="detail pannel-footer">
                ...
                <div class="col-md-7 col-sm-7">
                    ...
                    if($uid==$email1)
                    {
                        ...
                        echo '<div class="detail-pannel-footer-btn pull-right"><a href="update-company.php" class="footer-btn blu-btn" title="">Edit</a></div>';
                    }?>
