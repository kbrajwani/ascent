...
<!-- Mirrored from live.themezhub.com/job-stock-large-preview/job-stock/manage-employee.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Oct 2017 15:17:35 GMT -->
...
<body>
    ...
    <section class="manage-employee gray">
        <div class="container">
            <div class="row">
                <div class="search-filter">
                    ...
                    <div class="col-md-8 col-sm-7">
                        <div class="short-by pull-right">Short By
                            <div class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Dropdown <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                <ul
                                    class="dropdown-menu">
            ...
            <div class="col-md-4">
                <div class="jn-employee"><a href="#" class="mail-form"><i class="fa fa-envelope"></i></a>
                    <div class="pull-right">
                        <div class="btn-group action-btn"><button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></button>
                            <ul
                    ...
                    <div class="employee-caption">
                        <div class="employee-caption-pic"><img src="img/emp-1.jpg" class="img-responsive" alt="" /></div>
                        <h4>Anna Hoysted</h4><span class="designation">Web Designer</span>
            ...
            <div class="col-md-4">
                <div class="jn-employee"><a href="#" class="mail-form"><i class="fa fa-envelope"></i></a>
                    ...
                    <div class="employee-caption">
                        <div class="employee-caption-pic"><img src="img/emp-2.jpg" class="img-responsive" alt="" /></div>
                        <h4>Jesse Leslie</h4><span class="designation">App Designer</span>
            ...
            <div class="col-md-4">
                <div class="jn-employee"><a href="#" class="mail-form"><i class="fa fa-envelope"></i></a>
                    ...
                    <div class="employee-caption">
                        <div class="employee-caption-pic"><img src="img/emp-3.jpg" class="img-responsive" alt="" /></div>
                        <h4>Zane Joyner</h4><span class="designation">IOS Developer</span>
                        <ul class="employee-social">
                            <li><a href="#" title=""><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-google-plus"></i></a></li>
            ...
            <div class="col-md-4">
                <div class="jn-employee"><a href="#" class="mail-form"><i class="fa fa-envelope"></i></a>
                    ...
                    <div class="employee-caption">
                        <div class="employee-caption-pic"><img src="img/emp-4.jpg" class="img-responsive" alt="" /></div>
                        <h4>Finn Osman</h4><span class="designation">UI/UX Designer</span>
                        <ul class="employee-social">
                            <li><a href="#" title=""><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-google-plus"></i></a></li>
            ...
            <div class="col-md-4">
                <div class="jn-employee"><a href="#" class="mail-form"><i class="fa fa-envelope"></i></a>
                    ...
                    <div class="employee-caption">
                        <div class="employee-caption-pic"><img src="img/emp-5.jpg" class="img-responsive" alt="" /></div>
                        <h4>Taylah Axon</h4><span class="designation">PHP Developer</span>
                        <ul class="employee-social">
                            <li><a href="#" title=""><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-google-plus"></i></a></li>
            ...
            <div class="col-md-4">
                <div class="jn-employee"><a href="#" class="mail-form"><i class="fa fa-envelope"></i></a>
                    ...
                    <div class="employee-caption">
                        <div class="employee-caption-pic"><img src="img/emp-6.jpg" class="img-responsive" alt="" /></div>
                        <h4>Daniel Decose</h4><span class="designation">Web Designer</span>
                        <ul class="employee-social">
                            <li><a href="#" title=""><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-google-plus"></i></a></li>
            ...
            <div class="col-md-4">
                <div class="jn-employee"><a href="#" class="mail-form"><i class="fa fa-envelope"></i></a>
                    ...
                    <div class="employee-caption">
                        <div class="employee-caption-pic"><img src="img/emp-7.jpg" class="img-responsive" alt="" /></div>
                        <h4>Charlotte Griffiths</h4><span class="designation">SEO Expert</span>
                        <ul class="employee-social">
                            <li><a href="#" title=""><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-google-plus"></i></a></li>
            ...
            <div class="col-md-4">
                <div class="jn-employee"><a href="#" class="mail-form"><i class="fa fa-envelope"></i></a>
                    ...
                    <div class="employee-caption">
                        <div class="employee-caption-pic"><img src="img/emp-1.jpg" class="img-responsive" alt="" /></div>
                        <h4>Charlotte Penfold</h4><span class="designation">Java Developer</span>
                        <ul class="employee-social">
                            <li><a href="#" title=""><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-google-plus"></i></a></li>
            ...
            <div class="col-md-4">
                <div class="jn-employee"><a href="#" class="mail-form"><i class="fa fa-envelope"></i></a>
                    ...
                    <div class="employee-caption">
                        <div class="employee-caption-pic"><img src="img/emp-2.jpg" class="img-responsive" alt="" /></div>
                        <h4>Daniel Dax</h4><span class="designation">Web Designer</span>
                        <ul class="employee-social">
                            <li><a href="#" title=""><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#" title=""><i class="fa fa-google-plus"></i></a></li>
...
<!-- Mirrored from live.themezhub.com/job-stock-large-preview/job-stock/manage-employee.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Oct 2017 15:17:45 GMT -->
