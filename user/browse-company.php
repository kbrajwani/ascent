...
<!-- Mirrored from live.themezhub.com/job-stock-large-preview/job-stock/browse-company.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Oct 2017 15:17:26 GMT -->
        ...
        <div class="container">
            <div class="row extra-mrg">
                <div class="wrap-search-filter">
                    <form method="GET">
                    <div class="col-md-10 col-sm-10"><select required name="search" class="form-control" title="All Categories"> 
                        <?php
                        ...
                        $obj=new loginclass();
                            ...
                            {
                            echo '<option value="'.$rcat["cat_name"].'">'.$rcat["cat_name"].'</option>';
                            }?>
                        </select></div>
                        <div
...
{ 
    $sid=1;     
    echo '    <a href="company-detail.php?'.$row["fk_uid"].'" class="item-click">
                    <article>
                        <div class="brows-job-list">
                            ...
                            <div class="col-md-6 col-sm-5">
                                 <div class="brows-job-position">
                                    ...
                                    <p><span>'.$row["company_detail"].'</span><span class="brows-job-sallery"><i class="fa fa-money"></i>$750 - 800</span></p>
                                </div>
                            </div>
...
<!-- Mirrored from live.themezhub.com/job-stock-large-preview/job-stock/browse-company.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Oct 2017 15:17:28 GMT -->
